...
Any unicode character with the property `White_Space=yes` is a valid whitespace character.
In the interests of interoperability implementations SHOULD use an ASCII space (`%x20`) as whitespace.
